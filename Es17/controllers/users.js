/**
 * Middleware di autorizzazione in /middleware/authorize
 */
...
/**
 *  Chiamata logout in /api/Routes/users
 */

// app.get("/logout", authorize, logout);

/**
 *  Restrizione dell'upload delle immagini solo agli utenti
 */

// app.post("/:id/image", authorize, upload.single("image"), updateImage);

/**
 * Funzione di logout a riga 130
 */
